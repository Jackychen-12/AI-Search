...
/** Weekly AI insight report generated by LLM. */
export const WEEKLY_INSIGHT_PATH = path.join(DATA_DIR, "weekly-insight.json");

/** Weekly insights directory (per-week shards: data/weekly-insights/{startDate}.json). */
export const WEEKLY_INSIGHTS_DIR = path.join(DATA_DIR, "weekly-insights");
